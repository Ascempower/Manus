...
// This script calculates the contrast ratio between color combinations
...
console.log('Color Contrast Analysis for Choice Insurance Website');
console.log('====================================================');
...
// Identify specific problematic combinations from the design
console.log('\nSpecific Combinations Used in Design:');
console.log('====================================================');

// Check secondary (Teal Blue) with black text
...
// Check Teal Blue with Deep Forest Green text (common heading combination)
const tealBlueWithForestGreen = results.find(r => 
  r.background === 'Teal Blue' && r.foreground === 'Deep Forest Green'
);
console.log(`Teal Blue background with Deep Forest Green text: ${tealBlueWithForestGreen.ratio}:1 - ${tealBlueWithForestGreen.passesNormalText ? 'PASS' : 'FAIL'}`);
