// Contrast Checker Script - Validation
...
// Define the updated brand colors
const brandColors = {
  'White': '#FFFFFF',
  'Teal Blue': '#A7C9CA',
  'Teal Blue Dark': '#6A9B9D', // New darker version for better contrast
  'Deep Forest Green': '#42615A',
  'Warm Beige/Coral': '#DD8B66',
  'Warm Beige/Coral Dark': '#C06B46', // New darker version for better contrast
  'Black': '#000000'
};

// Check all color combinations
console.log('VALIDATION: Color Contrast Analysis for Choice Insurance Website');
console.log('==============================================================');
...
// Check Teal Blue Dark with white text
const tealBlueDarkWithWhite = results.find(r => 
  r.background === 'Teal Blue Dark' && r.foreground === 'White'
);
console.log(`Teal Blue Dark background with White text: ${tealBlueDarkWithWhite.ratio}:1 - ${tealBlueDarkWithWhite.passesNormalText ? 'PASS' : 'FAIL'}`);

// Check Warm Beige/Coral Dark with white text
const coralDarkWithWhite = results.find(r => 
  r.background === 'Warm Beige/Coral Dark' && r.foreground === 'White'
);
console.log(`Warm Beige/Coral Dark background with White text: ${coralDarkWithWhite.ratio}:1 - ${coralDarkWithWhite.passesNormalText ? 'PASS' : 'FAIL'}`);
...
// Check Teal Blue Dark with Deep Forest Green text
const tealBlueDarkWithForestGreen = results.find(r => 
  r.background === 'Teal Blue Dark' && r.foreground === 'Deep Forest Green'
);
console.log(`Teal Blue Dark background with Deep Forest Green text: ${tealBlueDarkWithForestGreen.ratio}:1 - ${tealBlueDarkWithForestGreen.passesNormalText ? 'PASS' : 'FAIL'}`);
