...
export const metadata: Metadata = {
  ...
  description: 'Choice Insurance Hub\'s HIPAA-compliant privacy policy detailing how we protect your personal and health information in accordance with federal regulations.',
};
...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="container mx-auto py-12 px-4 prose prose-lg max-w-4xl">
      ...
      <p>
        Choice Insurance Hub uses the collected data for various purposes:
      </p>
      <ul className="list-disc pl-6 space-y-2">
      ...
      <p>
        Choice Insurance Hub may disclose your Personal Data in the good faith belief that such action is necessary to:
      </p>
      <ul className="list-disc pl-6 space-y-2">
