  ...
  return (
    <div className="bg-brand-white text-brand-black">
      ...
      <div className="container mx-auto py-12 px-4">
        ...
        <section className="mb-12 bg-brand-teal-blue/10 p-8 rounded-lg">
          <h2 className="text-3xl font-bold mb-6 text-brand-deep-forest-green font-poppins">Your Life Insurance Partner: Choice Insurance Hub</h2>
          <div className="space-y-4 text-lg text-brand-black/80 leading-relaxed font-poppins">
            <p>
              Choosing the right life insurance policy is a critical decision. At Choice Insurance Hub, we simplify the process and help you secure the protection your family deserves. We offer:
            </p>
