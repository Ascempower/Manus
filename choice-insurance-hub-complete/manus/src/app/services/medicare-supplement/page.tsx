  ...
  return (
    <div className="bg-brand-white text-brand-black">
      ...
      <div className="container mx-auto py-12 px-4">
        ...
        <section className="mb-12 bg-brand-teal-blue/10 p-8 rounded-lg">
          <h2 className="text-3xl font-bold mb-6 text-brand-deep-forest-green font-poppins">How Choice Insurance Hub Can Help</h2>
          <div className="space-y-4 text-lg text-brand-black/80 leading-relaxed font-poppins">
            <p>
              Navigating the different Medigap plans and choosing the one that best fits your needs and budget can be challenging. At Choice Insurance Hub, our experienced agents specialize in Medicare solutions. We will:
            </p>
