...
export default function HomePage() {
  return (
    <>
      {/* Hero Section */}
      <section className="py-20 md:py-32 bg-gradient-to-b from-brand-teal-blue to-brand-white text-brand-deep-forest-green">
      ...
      <section className="py-16 md:py-24 bg-brand-white text-brand-black">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-brand-deep-forest-green font-poppins">About Choice Insurance Hub</h2>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { title: "Health Insurance", description: "Find individual and group health insurance plans through Choice Insurance Hub.", href: "/services/health-insurance" },
