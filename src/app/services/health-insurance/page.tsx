  ...
  return (
    <div className="bg-brand-white text-brand-black">
      ...
      <div className="container mx-auto py-12 px-4">
        ...
        <section className="mb-12 bg-brand-teal-blue/10 p-8 rounded-lg">
          <h2 className="text-3xl font-bold mb-6 text-brand-deep-forest-green font-poppins">How Choice Insurance Hub Can Assist You</h2>
          <div className="space-y-4 text-lg text-brand-black/80 leading-relaxed font-poppins">
            <p>
              Finding the right health insurance plan can be a daunting task. At Choice Insurance Hub, we are here to simplify the process and help you make an informed decision. Our licensed agents will:
            </p>
