...
export default function HomePage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative py-20 md:py-32 bg-brand-deeper-forest-green text-brand-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            <div className="md:w-3/5 text-left md:pr-8">
              <div className="inline-block px-4 py-1 rounded-full bg-brand-warm-beige-coral-dark/30 text-white text-sm font-medium mb-6">
                Personalized Insurance Solutions
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 font-poppins leading-tight">
                Your Trusted Partner for <span className="text-brand-warm-beige-coral-dark">Health, Life & Medicare</span> Insurance
              </h1>
            ...
            <div className="md:w-2/5 relative">
              <div className="bg-white rounded-lg shadow-xl p-6 text-brand-black">
                <h3 className="text-xl font-bold mb-4 text-brand-deeper-forest-green">Get a Personalized Quote</h3>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-brand-teal-blue/10 transition-all duration-300 hover:bg-brand-teal-blue/20 cursor-pointer group" title="Click to learn more about Medicare Solutions">
                    ...
                    <div>
                      <h4 className="font-medium text-brand-deep-forest-green group-hover:text-brand-deeper-forest-green transition-colors duration-300">Medicare Solutions</h4>
                      <p className="text-sm text-gray-600">Advantage, Supplement, and Part D plans</p>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-brand-teal-blue/10 transition-all duration-300 hover:bg-brand-teal-blue/20 cursor-pointer group" title="Click to learn more about Life Insurance">
                    <ShieldCheck className="text-brand-teal-blue-dark flex-shrink-0 group-hover:text-brand-deep-forest-green transition-colors duration-300" size={24} />
                    <div>
                      <h4 className="font-medium text-brand-deep-forest-green group-hover:text-brand-deeper-forest-green transition-colors duration-300">Life Insurance</h4>
                      <p className="text-sm text-gray-600">Term, Whole, and Universal Life options</p>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-brand-teal-blue/10 transition-all duration-300 hover:bg-brand-teal-blue/20 cursor-pointer group" title="Click to learn more about Health Insurance">
                    <ShieldCheck className="text-brand-teal-blue-dark flex-shrink-0 group-hover:text-brand-deep-forest-green transition-colors duration-300" size={24} />
                    <div>
                      <h4 className="font-medium text-brand-deep-forest-green group-hover:text-brand-deeper-forest-green transition-colors duration-300">Health Insurance</h4>
                      <p className="text-sm text-gray-600">Individual and family health plans</p>
                    </div>
                  </div>
                </div>
                
                <Button asChild className="w-full bg-brand-warm-beige-coral-dark hover:bg-brand-warm-beige-coral-darker text-white font-semibold shadow-md text-base">
      ...
      <section className="py-16 md:py-24 bg-brand-white text-brand-black">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button asChild className="bg-brand-warm-beige-coral-dark hover:bg-brand-warm-beige-coral-darker text-white shadow-md">
      ...
      <section className="py-16 md:py-24 bg-brand-white text-brand-black">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="p-6 rounded-lg hover:shadow-md transition-shadow duration-300">
      ...
      <section className="py-16 md:py-24 bg-brand-teal-blue/10">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-2xl mx-auto bg-brand-white p-8 rounded-lg shadow-lg text-brand-black hover:shadow-xl transition-shadow duration-300">
      ...
      <section className="relative py-20 md:py-32 bg-brand-deeper-forest-green text-brand-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-lg md:text-xl mb-10 max-w-2xl mx-auto text-brand-white/95 leading-relaxed">
          ...
          <Button size="lg" asChild className="bg-brand-warm-beige-coral-dark hover:bg-brand-warm-beige-coral-darker text-white font-semibold shadow-md min-w-[250px] text-base">
