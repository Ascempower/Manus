...
export default function TermsOfServicePage() {
  ...
  return (
    <div className="prose prose-lg container mx-auto max-w-4xl px-4 py-12">
      <h1 className="mb-10 text-center text-4xl font-bold text-blue-700">Terms of Service</h1>
      <p className="mb-8 text-center text-gray-600">Last Updated: {lastUpdated}</p>

      <p>
        Welcome to Choice Insurance Hub! These Terms of Service ("Terms", "Terms of Service") govern
        your use of our website https://www.choiceinsurancehub.com (the "Service") operated by
        Choice Insurance Hub ("us", "we", or "our").
      </p>
      <p>
        Please read these Terms of Service carefully before using our Service. Your access to and
      ...
      <h2 className="mb-4 mt-8 text-2xl font-semibold text-gray-800">Use of Our Service</h2>
      <p>
        Choice Insurance Hub provides information about insurance products and services. The
        information provided on this Service is for general informational purposes only and does not
        constitute professional financial or insurance advice. You should consult with a qualified
        professional before making any decisions based on the information provided on this Service.
      </p>
      ...
      <ul className="list-disc space-y-2 pl-6">
        ...
        <li>
          To impersonate or attempt to impersonate Choice Insurance Hub, a Choice Insurance Hub
        ...
        <li>
          ...
          Service, or which, as determined by us, may harm or offend Choice Insurance Hub or users
          of the Service or expose them to liability.
        </li>
      </ul>

      <h2 className="mb-4 mt-8 text-2xl font-semibold text-gray-800">Intellectual Property</h2>
      <p>
        The Service and its original content (excluding content provided by users), features, and
        functionality are and will remain the exclusive property of Choice Insurance Hub and its
        ...
        connection with any product or service without the prior written consent of Choice Insurance
        Hub.
      </p>

      <h2 className="mb-4 mt-8 text-2xl font-semibold text-gray-800">Links to Other Web Sites</h2>
      <p>
        Our Service may contain links to third-party web sites or services that are not owned or
        controlled by Choice Insurance Hub. Choice Insurance Hub has no control over, and assumes no
        responsibility for, the content, privacy policies, or practices of any third-party web sites
        or services. You further acknowledge and agree that Choice Insurance Hub shall not be
      ...
      <p>
        The Service is provided on an "AS IS" and "AS AVAILABLE" basis. Choice Insurance Hub makes
      ...
      <p>
        Neither Choice Insurance Hub nor any person associated with Choice Insurance Hub makes any
        warranty or representation with respect to the completeness, security, reliability, quality,
        accuracy, or availability of the services. Without limiting the foregoing, neither Choice
        Insurance Hub nor anyone associated with Choice Insurance Hub represents or warrants that
        the services, their content, or any services or items obtained through the services will be
      ...
      <p>
        Choice Insurance Hub hereby disclaims all warranties of any kind, whether express or
        implied, statutory, or otherwise, including but not limited to any warranties of
        merchantability, non-infringement, and fitness for particular purpose.
      </p>
      <p>
        In no event will Choice Insurance Hub, its affiliates, or their licensors, service
        ...
        the website, any websites linked to it, any content on the website or such other websites,
      ...
      <h2 className="mb-4 mt-8 text-2xl font-semibold text-gray-800">Governing Law</h2>
      <p>
      ...
      <h2 className="mb-4 mt-8 text-2xl font-semibold text-gray-800">Contact Us</h2>
