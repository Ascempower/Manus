      ...
      <Card className="border-orange-200 bg-white shadow-lg">
        <CardHeader className="pb-3">
          ...
          <CardDescription className="text-sm">
            We use cookies to enhance your browsing experience and analyze our traffic. These
            cookies are essential for the website to function properly.
          </CardDescription>
        </CardHeader>
        <CardContent className="pb-3">
          <p className="text-xs text-muted-foreground">
            By clicking "Accept", you consent to our use of essential cookies. We do not use
