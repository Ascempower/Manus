...
export default function CalendlyBadge({
  url = 'https://calendly.com/choiceinsurancehub/30-minute-meeting', // Fixed URL with correct path
  ...
  useEffect(() => {
    ...
    const loadCalendlyBadge = async () => {
      try {
        ...
        console.error('Error loading Calendly badge widget:', err);
      }
    };
    ...
    const initializeBadge = () => {
      ...
      try {
        ...
        console.error('Error initializing Calendly badge widget:', err);
      }
    };
